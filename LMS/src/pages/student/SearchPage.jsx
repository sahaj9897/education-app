...
const SearchPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#D9EAFD] dark:bg-[oklch(0.129_0.042_264.695)]">
...
const CourseNotFound = () => {
  return (
    <div className="flex bg-[#BBFBFF]flex-col items-center justify-center min-h-32 dark:bg-gray-900 p-6">
